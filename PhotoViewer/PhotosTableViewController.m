...
- (void)viewDidLoad
{
    ...
    [pic setName:@"Sea View"];
    [pic setFilename:@"overlook.png"];
    [pic setNotes:@"Lovely sea view"];
    [photos addObject:pic];
    
    pic = [[Photo alloc] init];
    [pic setName:@"Flag"];
    [pic setFilename:@"flag.png"];
    [pic setNotes:@"Look at that flag blowing in the wind!"];
    [photos addObject:pic];
    
    pic = [[Photo alloc] init];
    [pic setName:@"Beach"];
    [pic setFilename:@"beach.png"];
    [pic setNotes:@"Stormy out there today!"];
    [photos addObject:pic];
    
    pic = [[Photo alloc] init];
    [pic setName:@"Olives"];
    [pic setFilename:@"olives.png"];
    [pic setNotes:@"Olives looking ripe."];
    [photos addObject:pic];
    
    pic = [[Photo alloc] init];
    [pic setName:@"Old sign"];
    [pic setFilename:@"winery.png"];
    [pic setNotes:@"Old looking sign"];
    [photos addObject:pic];
